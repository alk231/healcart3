...
import NgoVerificationInput from "../NgoVerificationInput";
...
const MedicineApplyForm = () => {
    ...
    .object({
      ...
      verificationId: yup
        .string()
        .matches(/^[0-9]{5}$/, "Verification ID must be exactly 5 digits")
        .required("NGO verification ID is required"),
    })
    .required();
        ...
        <Grid container columnSpacing={2} rowSpacing="5px" mb={1.5}>
          <Grid item xs={12} sm={6}>
            <FormControl fullWidth sx={{ ...theme.customInput }}>
              <NgoVerificationInput
                value={watch("verificationId")}
                onChange={(e) => setValue("verificationId", e.target.value)}
